...
def get_args():
    arg_0 = rand_strided((321, 512), (512, 1), device='cuda:0', dtype=torch.float32)
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        triton_.run(*args, 164352, grid=grid(164352), stream=stream0)


def benchmark_all_configs(args):
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        return triton_.benchmark_all_configs(*args, 164352, grid=grid(164352))
